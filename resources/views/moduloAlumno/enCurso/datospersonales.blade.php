...
@section("title")
	<title>Datos personales | CLE System</title>
@endsection

@section('content')
	@section("titulo-form", "Datos personales")

	@section("action-form")
		action="{{route('alumno.update.profile')}}"
	@endsection
		...
		<div class="justify-content-center">
			<div class="row mb-3">
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
					...
					<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" autocomplete="off" required="" value="{{$usuario->alumno->persona->nombre}}">
				</div>
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
					<label for="ape_pat">Apellido Paterno</label>
					<input type="text" class="form-control" id="ape_pat" name="ape_pat" placeholder="Appellido Paterno" autocomplete="off" required="" value="{{$usuario->alumno->persona->ape_pat}}">
				</div>
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
					<label for="ape_mat">Apellido Materno</label>
					<input type="text" class="form-control" id="ape_mat" name="ape_mat" placeholder="Apellido Materno" autocomplete="off" required="" value="{{$usuario->alumno->persona->ape_mat}}">
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
					<label for="correo">Correo</label>
					<input type="email" class="form-control" id="correo" name="correo" placeholder="Correo Electronico" autocomplete="off" required="" value="{{$usuario->alumno->persona->correo}}">
				</div>
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
					<label for="tel">Teléfono</label>
					<input type="number" class="form-control" id="tel" name="tel" placeholder="Teléfono" autocomplete="off" required="" value="{{$usuario->alumno->persona->telefono}}">
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-3">
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-body">
					...
					<form action="{{route('alumno.update.pass')}}" method="post" id="EditFormCalificacion" class="needs-validation frm-pass" novalidate="">
						{{ method_field('patch') }}
						{{ csrf_field() }}
