{{-- modal para deshabilitar horario --}}
<div class="modal fade" id="ModalDeleteHorario" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalDeleteHorarioLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content" style="background-color: #FFC800;">
			<div class="modal-body">
				<form method="post" action="" id="FormDeleteHorario">
					...
					<div class="mb-3 d-flex justify-content-center">
						<h5>Desea deshabilitar este horario</h5>
					</div>
