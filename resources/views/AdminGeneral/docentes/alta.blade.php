{{-- modal para habilitar docente --}}
<div class="modal fade" id="ModalAltaDocente" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalAltaDocenteLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content" style="background-color: #FFC800;">
			<div class="modal-body">
				<form method="post" action="" id="FormAltaDocente">
					{{ csrf_field() }}	
					...
					<div class="mb-3 d-flex justify-content-center">
						<h5>Desea dar de alta a este Docente</h5>
					</div>
