<div class="modal fade" id="ModalDeleteDocentePer" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalDeleteDocentePerLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content" style="background-color: #FFC800;">
			<div class="modal-body">
				<form method="post" action="" id="FormDeleteDocentePer">
					...
					<div class="mb-1 d-flex justify-content-center">
						<h5>Desea eliminar este Docente</h5>
					</div>
