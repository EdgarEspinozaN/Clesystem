{{-- modal deshablitar aulas --}}
<div class="modal fade" id="ModalDeleteAula" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalDeleteAulaLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content" style="background-color: #FFC800;">
			<div class="modal-body">
				<form method="post" action="" id="FormDeleteAula">
					...
					<div class="mb-3 d-flex justify-content-center">
						<h5>Desea deshabilitar esta aula</h5>
					</div>
