{{-- modal para deshabilitar nivel --}}
<div class="modal fade" id="ModalDeleteNivel" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalDeleteNivelLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content" style="background-color: #FFC800;">
			<div class="modal-body">
				<form method="post" action="" id="FormDeleteNivel">
					{{ method_field('delete') }}
					{{ csrf_field() }}	
					...
					<div class="mb-3 d-flex justify-content-center">
						<h5>Desea deshabilitar este nivel</h5>
					</div>
